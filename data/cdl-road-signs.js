...
export const roadSigns = {
  regulatory: [
    ...
    },
    {
      ...
      image: '/signs/crosswalk.png', // Using crosswalk as pedestrian-related sign
      category: 'regulatory',
      importance: 'high',
      cdlSpecific: true,
      questions: [
  ...
  warning: [
    {
      ...
      image: '/signs/merge-left.svg', // Using merge-left as closest available
      category: 'warning',
      importance: 'high',
      cdlSpecific: true,
      questions: [
    ...
    },
    {
      ...
      image: '/signs/winding-road.png', // Using winding-road as closest available
      category: 'warning',
      importance: 'critical',
      cdlSpecific: true,
      questions: [
    ...
    },
    {
      ...
      image: '/signs/curve-ahead.png', // Using curve-ahead as warning sign alternative
      category: 'warning',
      importance: 'critical',
      cdlSpecific: true,
      questions: [
    ...
    },
    {
      ...
      image: '/signs/divided-highway-begins.png',
      category: 'warning',
      importance: 'medium',
      cdlSpecific: false,
      questions: [
    ...
    },
    {
      ...
      image: '/signs/railway-crossing.png',
      category: 'warning',
      importance: 'critical',
      cdlSpecific: true,
      questions: [
    ...
    },
    {
      ...
      image: '/signs/construction.png', // Using construction as closest hazard warning
      category: 'warning',
      importance: 'high',
      cdlSpecific: true,
      questions: [
  ...
  mandatory: [
    {
      ...
      image: '/signs/curve-right.png', // Using curve-right as directional alternative
      category: 'mandatory',
      importance: 'high',
      cdlSpecific: true,
      questions: [
    ...
    },
    {
      ...
      image: '/signs/curve-left.png', // Using curve-left as directional alternative
      category: 'mandatory',
      importance: 'high',
      cdlSpecific: true,
      questions: [
    ...
    },
    {
      ...
      image: '/signs/one-way.png', // Using one-way as directional alternative
      category: 'mandatory',
      importance: 'high',
      cdlSpecific: true,
      questions: [
